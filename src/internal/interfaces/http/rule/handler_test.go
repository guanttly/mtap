...
type htMockConflictRuleRepo struct{ rules map[string]*domain.ConflictRule }
...
func (m *htMockConflictRuleRepo) Delete(_ context.Context, id string) error { delete(m.rules, id); return nil }

type htMockConflictPkgRepo struct{ pkgs map[string]*domain.ConflictPackage }
...
func (m *htMockConflictPkgRepo) Delete(_ context.Context, id string) error { delete(m.pkgs, id); return nil }

type htMockDepRuleRepo struct{ rules map[string]*domain.DependencyRule }
...
func (m *htMockDepRuleRepo) Delete(_ context.Context, id string) error { delete(m.rules, id); return nil }

type htMockTagRepo struct{ tags map[string]*domain.PriorityTag }
...
m.items = append(m.items, s); return nil
}
